//import { useSyntheticShadow } from './env';
//import { VElement, VNode, VNodes } from '../../engine/src/3rdparty/snabbdom/types';
import { VElement, VNode, VNodes } from '@lwc/engine/src/3rdparty/snabbdom/types';
...
function isElement(node: VNode): boolean {
    return !!node.sel;
}
...
function isText(node: VNode): boolean {
